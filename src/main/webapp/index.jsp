...
<div class="h-5/6 flex items-center mt-20">
    <div class="hidden lg:flex w-full lg:w-1/2 login_img_section
        ...
        <img src="./views/components/images/undraw_aircraft_re_m05i.svg" alt="" class="w-full">
    </div>
    <div class="flex w-full lg:w-1/2 justify-center items-center  space-y-8">
        <div class="mx-auto w-full max-w-[550px]">
            <form action="" method="POST">
                ...
                <div>
                    <button type="submit"
                            class="w-full flex justify-center bg-gradient-to-r from-orange-500 to-amber-600  hover:bg-gradient-to-l hover:from-amber-500 hover:to-orange-500 text-gray-100 p-4  rounded-md tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500"
                    >
                        Submit
                    </button>
                </div>
