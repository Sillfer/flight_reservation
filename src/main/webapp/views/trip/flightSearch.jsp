    ...
    <img src="https://image.winudf.com/v2/image1/Y29tLmJldHMuYWlyaW5kaWEudWlfaWNvbl8xNTU0NTM4MzcxXzA0Mw/icon.png?w=&amp;fakeurl=1"
         class="h-8 p-1">
                        ...
                        <div class="flex justify-center px-5 text-sm">
                            <button class="text-blue-800 border border-blue-800 hover:bg-blue-800 hover:text-white active:bg-blue-900 font-bold uppercase px-8 py-3 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                    type="button"
                            >
                                Reserve
                            </button>
